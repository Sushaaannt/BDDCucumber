package apiAutomation.Chapter01;
...
public class FirstChapterTests {
    ...
    public void sendAGETRequestAndValidateResponse() {
        given()
                ...
                .then()
                .statusCode(200) // It verifies the actual response code with the given code
    ...
    // Here we're testing the GET API, by passing the query parameters in the URL
    @Test
